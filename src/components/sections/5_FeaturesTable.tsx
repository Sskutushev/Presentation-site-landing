      ...
      >
        ...
        <div className="mt-20">
          <div className="min-w-full inline-block align-middle">
            <motion.div
              variants={fadeInUp}
              className="overflow-hidden border border-c-border rounded-2xl shadow-2xl bg-white/5 backdrop-blur-md"
            >
              <table className="min-w-full divide-y divide-c-border hidden sm:table">
                <thead className="bg-c-bg-secondary/50 backdrop-blur-sm">
                  <tr>
                    ...
                    <th
                      scope="col"
                      className="py-5 px-6 text-center text-lg font-bold text-c-text-primary bg-gradient-to-r from-c-primary/10 to-transparent"
                    >
                      <div className="flex items-center justify-center">
                        <img
                          src="/Logo.png"
                          alt="DexSafe.Pro Logo"
                    ...
                    <th
                      scope="col"
                      className="py-5 px-6 text-center text-lg font-bold text-c-text-secondary"
                    >
                      <div className="flex items-center justify-center">
                        <img
                ...
                <tbody className="divide-y divide-c-bg-tertiary">
                  {features.map((feature, idx) => (
                    <motion.tr
                      variants={fadeInUp}
                      key={idx}
                      className="hover:bg-c-bg-tertiary/40 transition-colors duration-200"
                    >
                      ...
                      <td className="py-5 px-6 whitespace-nowrap text-center">
                        <div className="flex justify-center">{renderCheck(feature.dexsafe)}</div>
                      </td>
