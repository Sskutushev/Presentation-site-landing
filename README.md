...
**Секции (sections):**
- `0_Header.tsx` — шапка сайта с навигацией и логотипом
...
- `4_UpaSection.tsx` — секция, посвященная UPA Engine
- `5_FeaturesTable.tsx` — таблица с описанием функций кошелька
- `6_StatusSection.tsx` — секция с текущим статусом проекта
- `7_RoadmapSection.tsx` — дорожная карта развития
- `8_ContactSection.tsx` — контактная информация
...
- `en/translation.json` — английские переводы
- `ru/translation.json` — русские переводы
...
### E2E тесты
Для тестирования пользовательских сценариев используется Cypress.
